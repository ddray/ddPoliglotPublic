...
namespace ddPoliglotV6.Data.Migrations
{
    ...
    [Migration("20220806175735_DictVersionNativLngField")]
    partial class DictVersionNativLngField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ddPoliglotV6.Data.Models.DictionaryVersion", b =>
                {
                    b.Property<int>("DictionaryVersionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .UseIdentityColumn();
            ...
            modelBuilder.Entity("ddPoliglotV6.Data.Models.Lesson", b =>
                {
                    ...
                    b.Property<string>("PageMetaTitle")
                        .HasMaxLength(500)
            ...
            modelBuilder.Entity("ddPoliglotV6.Data.Models.UserLanguageLevel", b =>
                {
                    b.Property<int>("UserLanguageLevelID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .UseIdentityColumn();
            ...
            modelBuilder.Entity("ddPoliglotV6.Data.Models.UserLesson", b =>
                {
            ...
            modelBuilder.Entity("ddPoliglotV6.Data.Models.UserLessonWord", b =>
                {
                    b.Property<int>("UserLessonWordID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .UseIdentityColumn();
                    ...
                    b.HasKey("UserLessonWordID");

                    b.HasIndex("UserLessonID");

                    b.HasIndex("WordID");

                    b.ToTable("UserLessonWords");
                });
            ...
            modelBuilder.Entity("ddPoliglotV6.Data.Models.Word", b =>
                {
                    ...
                    b.Property<int>("RateTmp2")
                        .HasColumnType("int");

                    b.Property<int>("RateTmp3")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ddPoliglotV6.Data.Models.WordUser", b =>
                {
                    ...
                    b.Property<string>("RepeatHistory")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ddPoliglotV6.Data.Models.UserLessonWord", b =>
                {
                    b.HasOne("ddPoliglotV6.Data.Models.UserLesson", null)
                        .WithMany("UserLessonWords")
